...
## 2026-04-27 — UI 3탭 구조 확정

- **파츠 메타 편집**: 눈/코/입/수염/머리카락/바디·페이스 템플릿 메타 편집 (threshold, beauty, age)
- **장비 에셋 편집**: armor/helmet 전용 (nameKey, texture, threshold, beauty, age)
- **캐릭터 에셋 편집**: 캐릭터 조합 (파츠 선택, color, scale, offsetX/Y)
- 파츠 메타/장비는 에셋 제작 시 1회, 캐릭터는 캐릭터마다 반복
- **반영 문서:** [[27_UI_Layout]]
